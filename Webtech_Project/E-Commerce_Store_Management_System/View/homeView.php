...
<div class="hero" id="hero-section" <?php echo $searchKeyword !== '' ? 'style="display:none;"' : ''; ?>>
...
<div class="category-section" id="category-section" <?php echo $searchKeyword !== '' ? 'style="display:none;"' : ''; ?>>
